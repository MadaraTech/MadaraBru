package jtm.activity10;import java.io.*;
import java.nio.file.Files;
import java.nio.file.Paths;
import java.util.ArrayList;
import java.util.List;import org.apache.commons.io.FilenameUtils;
import org.apache.maven.shared.utils.io.FileUtils;public class FileCopy {    /*
        TODO
    ...
    public void copyFile(String filePath) throws IOException {
    	...
    	FileUtils.copyFile(source, dest);//    	List<String> lns = Files.readAllLines(Paths.get(filePath));
